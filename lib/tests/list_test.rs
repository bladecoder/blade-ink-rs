...
fn list_basic_operations_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/basic-operations.ink.json")?;
...
fn list_mixed_items_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/list-mixed-items.ink.json")?;
    let mut story = Story::new(&json_string)?;
...
fn more_list_operations_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/more-list-operations.ink.json")?;
    let mut story = Story::new(&json_string)?;
...
fn empty_list_origin_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/empty-list-origin.ink.json")?;
    let mut story = Story::new(&json_string)?;
...
fn list_save_load_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/list-save-load.ink.json")?;
    let mut story = Story::new(&json_string)?;
...
fn list_range_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/list-range.ink.json")?;
    let mut story = Story::new(&json_string)?;
...
fn list_bug_adding_element_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/bug-adding-element.ink.json")?;
    let mut story = Story::new(&json_string)?;
...
fn more_list_operations2_test() -> Result<(), Box<dyn Error>> {
    let json_string =
        common::get_json_string("tests/data/lists/more-list-operations2.ink.json")?;
    let mut story = Story::new(&json_string)?;
