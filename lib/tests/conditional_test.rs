...
fn cond_text1_test() -> Result<(), StoryError>  {
    ...
    assert_eq!("I stared at Monsieur Fogg. \"But surely you are not serious?\" I demanded.", text[1]);
...
fn cond_text2_test() -> Result<(), StoryError>  {
    ...
    assert_eq!(2, text.len());
    assert_eq!("I stared at Monsieur Fogg. \"But there must be a reason for this trip,\" I observed.", text[0]);
